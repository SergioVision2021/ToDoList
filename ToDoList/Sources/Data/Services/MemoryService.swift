...
class MemoryService: TaskService {
    ...
    func load() {
        ...
        source.append(Group.init(
            id: 1, name: "Hobby", tasks: [Task.init(groupId: 1,
                                                   name: "Собрать кухню",
                                                   taskScheduledDate: ConvertDate().convert(from: "2022-02-20"),
                                                   notes: "Нет времени",
                                                   status: false)]))
        source.append(Group.init(
            id: 2, name: "Work", tasks: [Task.init(groupId: 2,
                                         ...
                                         Task.init(groupId: 2,
                                                   ...
                                                   status: false)]))
        source.append(Group.init(
            id: 3, name: "Films", tasks: [Task.init(groupId: 3,
                                         ...
                                         Task.init(groupId: 3,
                                                   ...
                                                   status: false)]))
        source.append(Group.init(
            id: 4, name: "Building", tasks: [Task.init(groupId: 4,
                                                      name: "task 0",
                                                      taskScheduledDate: ConvertDate().convert(from: "2022-02-17"),
                                                      notes: "nnnnnn",
                                                      status: false),
