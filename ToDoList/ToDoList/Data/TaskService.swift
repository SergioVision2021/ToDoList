...
class TaskService{
    ...
    init(){
        ...
        source.append(Group.init(
            id: 2, name: "Work", list: [Task.init(id: 2, name: "Написать тестовое задание", taskScheduledDate: ConvertDate().convert(from: "2022-02-15"), notes: "Самообразование", status: false),
                                         ...
                                         Task.init(id: 2, name: "Проверить invite от AppleID", taskDeadline: ConvertDate().convert(from: "2022-02-15"), taskScheduledDate: ConvertDate().convert(from: "2022-02-15"), notes: "На почте от  Cetelem", status: true),
